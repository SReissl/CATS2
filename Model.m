...
function  [Y_real,prob_DD_b,noprod,cactual,cdemand1,cdemand2,welfare_cs,welfare_dc1s,welfare_dc2s,welfare_c,welfare_dc1,welfare_dc2,Ygap,rDIV,rDIVK,dincome,dincomek,DIV,DIVK,OCC,wincome,deviation,opt_share,neut_share,pes_share,types_agg,gperiod,Growth,Dek,Dek2,Kdem2,bankruptcy_rate,residualC,YP_e,YP_u,prob_EE,prob_EU,prob_UU,prob_UE,prob_EE_p,prob_EU_p,prob_UU_p,prob_UE_p,prob_DD,prob_DN,prob_NN,prob_ND,prob_DD_k,prob_DN_k,prob_NN_k,prob_ND_k,price,Div_prob,Div_probb,Div_probk,profitsB,Cdivs_p,Kdivs_p,shares,dividendsB,EXPcontrol,Invent,Assets,baryk,Kdes,Kdem,Dexp,Kdivs,Cdivs,valI,unsatisfiedDemandK,actualEXP,X1,X2,totK, gdp_deflator, Investment,I, consumption, Prod_k, Prod_c, Un, totalDeb, totalDeb_k,stock_bonds,GB,TA,G,wages_t, DC,totE,average_interest_rate,average_interest_rate_k,average_interest_all,impulse_rw_opt,YPE_true,YPE_anchor,YPU_true,YPU_anchor,rwage,Occ_status,Type,bonds_real,et] = Model(seed, T, par,Hor)
tic 
...
average_interest_all=zeros(1,T);
...
%% CREDIT MARKET OPENS
    ...
    average_interest_all(t)=(sum(interest_r_k.*deb_k)+sum(interest_r.*deb))/(sum(deb_k)+sum(deb));
